...
import { queEsPizarraOnlineTranslation } from "@/public/locales/pizarra-online/que-es-pizarra-online";

export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
    const translation = queEsPizarraOnlineTranslation[params.lang as keyof typeof queEsPizarraOnlineTranslation];
    return {
...
const LandingPage = ({ params }: { params: { lang: string } }) => {
    const t = queEsPizarraOnlineTranslation[params.lang as keyof typeof queEsPizarraOnlineTranslation];
            ...
            <div className="mt-[3%]">
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <Link href={`/${params.lang}/pizarra-online/`} title={t.breadcrumbs.pizarraOnline}>{t.breadcrumbs.pizarraOnline}</Link>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage className="text-white">{t.breadcrumbs.queEsPizarraOnline}</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
