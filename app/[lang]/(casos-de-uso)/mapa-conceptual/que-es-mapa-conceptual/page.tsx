...
import { QueEsMapaConceptualTranslation } from "@/public/locales/mapa-conceptual/que-es-mapa-conceptual";
import React from "react";

export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
    const translation = QueEsMapaConceptualTranslation[params.lang as keyof typeof QueEsMapaConceptualTranslation];
    return {
...
const LandingPage = ({ params }: { params: { lang: string } }) => {
    const t = QueEsMapaConceptualTranslation[params.lang as keyof typeof QueEsMapaConceptualTranslation];
            ...
            <div className="mt-[3%]">
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <Link href={`/${params.lang}/mapa-conceptual/`} title={t.breadcrumbs.mapaConceptual}>{t.breadcrumbs.mapaConceptual}</Link>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage className="text-black">{t.breadcrumbs.queEsMapaConceptual}</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
