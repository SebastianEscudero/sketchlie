...
import { mapaDeProcesosTranslations } from "@/public/locales/mapa-de-procesos.ts/mapa-de-procesos";

export async function generateMetadata({ params: { lang } }: { params: { lang: Language } }): Promise<Metadata> {
    const t = mapaDeProcesosTranslations[lang];
    return t.metadata;
}
        ...
        <div>
            <Breadcrumb className="xl:px-[15%] lg:px-[7%] md:px-[5%] px-[5%] pt-5 bg-blue-600">
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbPage className="text-white">{t.breadcrumbs.mapaDeProcesos}</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
            <BlogStructure
            ...
            <HowToCreate steps={t.howToCreate.steps} title={t.howToCreate.title} img="/templates/mapa-de-proceso.png" alt={t.howToCreate.alt} cta={t.howToCreate.cta}/>
            <TemplatesSlider />
