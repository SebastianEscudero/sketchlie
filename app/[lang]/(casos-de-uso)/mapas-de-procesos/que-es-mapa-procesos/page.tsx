...
import { MapaDeProcesosTranslation } from "@/public/locales/mapa-de-procesos.ts/que-es-mapa-de-procesos";

export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
    const translation = MapaDeProcesosTranslation[params.lang as keyof typeof MapaDeProcesosTranslation];
    return {
...
const LandingPage = ({ params }: { params: { lang: string } }) => {
    const t = MapaDeProcesosTranslation[params.lang as keyof typeof MapaDeProcesosTranslation];
            ...
            <div className="mt-[3%]">
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <Link href={`/${params.lang}/mapa-de-procesos/`} title={t.breadcrumbs.mapaDeProcesos}>{t.breadcrumbs.mapaDeProcesos}</Link>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
