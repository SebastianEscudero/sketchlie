...
export const ShapesMenu = ({
    ...
    return (
        <div className="absolute left-[60px] bottom-16 p-2 bg-white dark:bg-zinc-800 rounded-lg shadow-sm grid grid-cols-4 grid-rows-3 gap-2 h-[144px] w-[160px] sm:w-[192px] items-center cursor-default">
          <ToolButton
            icon={Square}
