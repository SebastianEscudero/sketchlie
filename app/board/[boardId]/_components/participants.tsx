...
export const Participants = ({
    ...
    return (
        <div className="absolute h-12 right-0 bg-white dark:bg-[#383838] rounded-bl-lg p-3 flex items-center shadow-custom-1 dark:shadow-custom-3 pointer-events-auto">
