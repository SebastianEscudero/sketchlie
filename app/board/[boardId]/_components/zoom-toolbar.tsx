...
export const ZoomToolbar = ({
    ...
    return (
        <div className="border dark:border-zinc-800 shadow-md absolute h-[52px] bottom-2 left-2 rounded-xl py-2 items-center lg:flex hidden bg-white dark:bg-zinc-800 pointer-events-auto">
