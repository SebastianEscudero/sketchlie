...
export const ZoomToolbar = ({
    ...
    return (
        <div className="border dark:border-zinc-700 shadow-md absolute h-[52px] bottom-2 left-2 rounded-lg py-2 items-center sm:flex hidden bg-white dark:bg-[#272727] pointer-events-auto">
