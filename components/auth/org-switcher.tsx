...
export const OrganizationSwitcher = ({
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="dark:bg-[#383838] bg-[#f2f4f7] dark:hover:bg-zinc-700 hover:bg-zinc-200 rounded-sm p-[10px] flex items-center w-full outline-none">
                {hasOrg && activeOrg ? (
